...
const localOffers: VendorOffer[] = [
  ...
  { id: "mobile-a-1", vendorId: "vendor-a", vendorName: "Vendor A", productCategory: "mobile", productName: "Pulse Field 5G", description: "5G mobile device with 8 GB RAM, 128 GB storage and 5000 mAh battery", attributes: { ram_gb: 8, storage_gb: 128, network_5g: true, battery_mah: 5000 }, unitPriceInr: 19900, availableQuantity: 20, availability: "in_stock", deliveryDays: 3, sellerRating: 4.7, returnDays: 14, returnPolicy: "14 days", sourceType: "simulated", sourceReference: "mobile-a-1" },
  { id: "mobile-b-1", vendorId: "vendor-b", vendorName: "Vendor B", productCategory: "mobile", productName: "Link Pro 5G", description: "5G mobile device with 8 GB RAM, 256 GB storage and 5000 mAh battery", attributes: { ram_gb: 8, storage_gb: 256, network_5g: true, battery_mah: 5000 }, unitPriceInr: 21500, availableQuantity: 18, availability: "in_stock", deliveryDays: 4, sellerRating: 4.5, returnDays: 10, returnPolicy: "10 days", sourceType: "simulated", sourceReference: "mobile-b-1" },
  { id: "mobile-a-2", vendorId: "vendor-a", vendorName: "Vendor A", productCategory: "mobile", productName: "Pulse Compact", description: "4G mobile device with 6 GB RAM, 64 GB storage and 4500 mAh battery", attributes: { ram_gb: 6, storage_gb: 64, network_5g: false, battery_mah: 4500 }, unitPriceInr: 14900, availableQuantity: 26, availability: "in_stock", deliveryDays: 2, sellerRating: 4.4, returnDays: 7, returnPolicy: "7 days", sourceType: "simulated", sourceReference: "mobile-a-2" },
  ...
  { id: "mouse-a-1", vendorId: "vendor-a", vendorName: "Vendor A", productCategory: "mouse", productName: "Pointer M185 Wireless", description: "M185-compatible wireless computer mouse with 1000 DPI optical sensor", attributes: { mouse_model: "m185", connection: "wireless", dpi: 1000 }, unitPriceInr: 1299, availableQuantity: 28, availability: "in_stock", deliveryDays: 2, sellerRating: 4.7, returnDays: 14, returnPolicy: "14 days", sourceType: "simulated", sourceReference: "mouse-a-1" },
  { id: "mouse-b-1", vendorId: "vendor-b", vendorName: "Vendor B", productCategory: "mouse", productName: "Arc M185 Wireless", description: "M185-compatible wireless computer mouse with 1200 DPI optical sensor", attributes: { mouse_model: "m185", connection: "wireless", dpi: 1200 }, unitPriceInr: 1499, availableQuantity: 22, availability: "in_stock", deliveryDays: 3, sellerRating: 4.5, returnDays: 10, returnPolicy: "10 days", sourceType: "simulated", sourceReference: "mouse-b-1" },
  { id: "mouse-b-2", vendorId: "vendor-b", vendorName: "Vendor B", productCategory: "mouse", productName: "Arc Wired 800", description: "Wired computer mouse with 800 DPI optical sensor", attributes: { mouse_model: "arc-800", connection: "wired", dpi: 800 }, unitPriceInr: 699, availableQuantity: 40, availability: "in_stock", deliveryDays: 2, sellerRating: 4.2, returnDays: 7, returnPolicy: "7 days", sourceType: "simulated", sourceReference: "mouse-b-2" },
  { id: "gpu-a-1", vendorId: "vendor-a", vendorName: "Vendor A", productCategory: "gpu", productName: "Forge RTX 4060 8 GB", description: "RTX 4060 graphics card with 8 GB GDDR6 memory and dual-slot form factor", attributes: { gpu_model: "rtx 4060", vram_gb: 8, form_factor: "dual slot" }, unitPriceInr: 19500, availableQuantity: 7, availability: "in_stock", deliveryDays: 5, sellerRating: 4.8, returnDays: 14, returnPolicy: "14 days", sourceType: "simulated", sourceReference: "gpu-a-1" },
  { id: "gpu-b-1", vendorId: "vendor-b", vendorName: "Vendor B", productCategory: "gpu", productName: "Vector RTX 4060 8 GB", description: "RTX 4060 graphics card with 8 GB GDDR6 memory and compact dual-slot design", attributes: { gpu_model: "rtx 4060", vram_gb: 8, form_factor: "dual slot" }, unitPriceInr: 19850, availableQuantity: 9, availability: "in_stock", deliveryDays: 6, sellerRating: 4.5, returnDays: 10, returnPolicy: "10 days", sourceType: "simulated", sourceReference: "gpu-b-1" },
  { id: "gpu-b-2", vendorId: "vendor-b", vendorName: "Vendor B", productCategory: "gpu", productName: "Vector RTX 3050 6 GB", description: "RTX 3050 graphics card with 6 GB GDDR6 memory", attributes: { gpu_model: "rtx 3050", vram_gb: 6, form_factor: "dual slot" }, unitPriceInr: 17200, availableQuantity: 14, availability: "in_stock", deliveryDays: 4, sellerRating: 4.3, returnDays: 7, returnPolicy: "7 days", sourceType: "simulated", sourceReference: "gpu-b-2" },
...
export function recordMarketplaceSearchOutcome(session: GenericProcurementSession, outcome: { status: "live" | "fallback"; listingCount: number; unverifiedListingCount?: number; message?: string }): GenericProcurementSession {
  const audit = [...session.audit];
  const localCandidateCount = session.recommendation.candidates.length;
  if (outcome.status === "live") {
    const verificationDetail = outcome.unverifiedListingCount ? ` ${outcome.unverifiedListingCount} card${outcome.unverifiedListingCount === 1 ? " is" : "s are"} incomplete and requires explicit page or seller verification before procurement.` : " All returned cards include the marketplace fields needed for their current policy label; seller confirmation still remains required before procurement.";
    addEvent(audit, { type: "MARKETPLACE_RESULTS_RECEIVED", actor: "Procurement agent", itemId: session.brief.id, summary: `Marketplace search returned ${outcome.listingCount} product card${outcome.listingCount === 1 ? "" : "s"}.`, detail: `Marketplace cards remain evidence records; local Vendor A/B policy comparison is separate.${verificationDetail}` });
  } else {
