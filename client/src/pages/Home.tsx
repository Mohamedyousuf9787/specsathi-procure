...
import EditableRequirementReview from "@/components/EditableRequirementReview";
...
export default function Home() {
  ...
  const startProcurement = async (confirmedBrief = validation?.normalizedBrief) => {
  ...
  return <div className="min-h-screen bg-[#f6f5f4] text-[#31302e]">
    ...
    {view === "generic-workspace" && genericSession && <main className="mx-auto max-w-[1360px] px-4 sm:px-6 lg:px-8"><GenericProcurementWorkspace session={genericSession} onSessionChange={setGenericSession} onNewBrief={newBrief} onLoadMultiDemo={loadMultiDemo} liveEvidence={liveEvidence} productListings={productListings} auditPersistence={auditPersistence} /></main>}
