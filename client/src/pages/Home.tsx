...
import { furnitureDemoBrief, laptopDemoBrief, mobileDemoBrief, mouseDemoBrief, tyreDemoBrief, type BuyingBrief } from "@/domain/generic-procurement";
