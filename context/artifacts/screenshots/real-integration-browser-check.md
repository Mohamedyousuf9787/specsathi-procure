...
The managed desktop screenshot subsequently verified the rendered visual surface: the receipt-check brand header, deep-indigo control banner, focused natural-language form, explicit secure-NLP checkbox disclosure, three-step policy tape, local-fallback statement, restrained blue primary action, and simulation notice all render legibly at desktop width.
